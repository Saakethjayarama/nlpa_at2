...
def fine_tune_mt5(model_name, train_df, output_dir, batch_size=8, epochs=3, max_length=128): # Added max_length
    ...
    tokenized_data = tokenize_function(tokenized_datasets) # Store tokenized data directly
    ...
    train_dataset = TranslationDataset(tokenized_data) # Use the stored tokenized data
